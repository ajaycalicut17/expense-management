                ...
                <div class="px-4 py-3 bg-white">
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-8 sm:col-span-6">
                        ...
                        <x-input id="amount" class="block mt-1 w-full" type="number" step="0.01" min="0" name="amount" :value="old('amount')" required />
                    </div>
                  </div>
                </div>
                <div class="px-4 py-3 bg-white">
                ...
                <div class="px-4 py-3 bg-white">
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-8 sm:col-span-6">
                        ...
                        <x-input id="spent_at" class="block mt-1 w-full" type="datetime-local" name="spent_at" :value="old('spent_at')" required />
                    </div>
                  </div>
                </div>
                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                  <a href="{{ route('expense.index') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-black bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    Back
                  </a>
